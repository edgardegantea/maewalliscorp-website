...
<head>
    ...
    <title>Recuperar contraseña — MAEWALLISCORP Admin</title>
    <style>
        body {
            margin: 0;
            min-height: 100vh;
...
<body>
    <div class="login-card">
        ...
        <form method="post" action="/admin/password/send-code">
            <?= csrf_field() ?>
            <div class="field">
        ...
        <a class="back-link" href="/admin/login">Volver a iniciar sesión</a>
    </div>
</body>
</html>
